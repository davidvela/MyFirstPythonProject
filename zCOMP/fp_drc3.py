...
#     if p_abs == False:
#         n=2
#     col_df = pd.read_csv(columns_path, index_col=n, sep=',', usecols=[0,1,2,3])
...
#     col_df = pd.read_csv(url_comp, index_col=0, sep=',', usecols=[0,1,2,3])
#     print("columns: " + str(len(self.col_df)))
#     # self.col_df  = pd.read_csv(url_col,  index_col=0, sep=',', usecols=[0])
#     # print("columns: " + str(len(self.col_df)))
#     lab_df = pd.read_csv(url_lab, index_col=0, sep=',', usecols=[0])
